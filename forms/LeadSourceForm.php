               ...
               <div class="span12">
                  <div class="portlet box blue" id="form_wizard_1">
                     <div class="portlet-title">
                        <div class="caption">
                           <i class="icon-reorder"></i>Lead Source Details Form - <span class="step-title">Step 1 of 2</span>
                        </div>
                           ...
                           <div class="form-wizard">
                                 ...
                                 <div class="navbar-inner">
                                    <ul class="row-fluid">
                                       <li class="span3">
                                          ...
                                          <span class="desc"><i class="icon-ok"></i> Lead Source Setup </span>   
                                          </a>
                                       </li>
                                       <li class="span3">
                              ...
                              <div class="tab-content">
                                 <div class="tab-pane active" id="tab1">
                                    <h3 class="block">Lead Source </h3>
                                    <div class="control-group">
                                       <label class="control-label">Lead Source </label>
                                       <div class="controls">
                                          <input id ="lead_source" type="text" name="lead_source" class="span6 m-wrap" />
                                          <span class="help-inline">Enter your Lead Source Details</span>
                                       </div>
                                    </div>
