 ...
 <!-- BEGIN PAGE CONTAINER-->
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  <h3 class="page-title">
                     User Transactions Form Wizard
                     <small> User Transactions</small>
                  </h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
               ...
               <div class="span12">
                  <div class="portlet box blue" id="form_wizard_1">
                     <div class="portlet-title">
                        <div class="caption">
                           <i class="icon-reorder"></i>  User Transactions Details Form - <span class="step-title">Step 1 of 2</span>
                        </div>
                           ...
                           <div class="form-wizard">
                                 ...
                                 <div class="navbar-inner">
                                    <ul class="row-fluid">
                                       <li class="span3">
                                          ...
                                          <span class="desc"><i class="icon-ok"></i>  User Transactions Setup </span>   
                                          </a>
                                       </li>
                                       <li class="span3">
                              ...
                              <div class="tab-content">
                                 <div class="tab-pane active" id="tab1">
                                    <h3 class="block"> User Transactions</h3>
                                   ...
                                   <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input id ="balance" type="text" name="balance" class="span6 m-wrap" />
                                 ...
                                 <div class="tab-pane" id="tab4">
									...
									<div class="control-group">
                                       ...
                                       <div class="controls">
                                          <span  class="text">
										  <span class = "text" id="confirm_balance"></span>
										  </span>
                                       </div>
                                    </div>
                                    <div class="control-group">
   ...
   <script>
     function myconfirmbranch(){
			...
			$('#confirm_balance').text(document.getElementById("balance").value); 
	 }
   </script>
