         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  <h3 class="page-title">
                     Company Form Wizard
                     <small>Create a Company Unitary Service Calls</small>
                  </h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
                     ...
                     <li>
                        <a href="#">Company Unitary Service Calls</a>
                        <span class="icon-angle-right"></span>
                     </li>
               ...
               <div class="span12">
                  <div class="portlet box blue" id="form_wizard_1">
                     <div class="portlet-title">
                        <div class="caption">
                           <i class="icon-reorder"></i> Company Unitary Service Calls - <span class="step-title">Step 1 of 2</span>
                        </div>
                           ...
                           <div class="form-wizard">
                                 ...
                                 <div class="navbar-inner">
                                    <ul class="row-fluid">
                                       <li class="span3">
                                          ...
                                          <span class="desc"><i class="icon-ok"></i> Unitary Service Call  Setup </span>   
                                          </a>
                                       </li>
                                       <li class="span3">
                              ...
                              <div class="tab-content">
                                 <div class="tab-pane active" id="tab1">
                                    <h3 class="block">Unitary Service Call Details</h3>
									...
									<div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input id ="contact_id" type="text" name="contact_id" class="span6 m-wrap" />
                                       </div>
                                    </div>
									<div class="control-group">
                                       <label class="control-label">Brand Reminder Id</label>
                                       <div class="controls">
                                          <input id ="brand_reminder" type="text" name="brand_reminder" class="span6 m-wrap" />
                                       </div>
                                    </div>
                                    <div class="control-group">
                                 ...
                                 <div class="tab-pane" id="tab4">
									...
									<div class="control-group">
                                       <label class="control-label">Brand Reminder:</label>
                                       <div class="controls">
                                          <span  class="text">
										  <span class = "text" id="confirm_brand_reminder"></span>
										  </span>
                                       </div>
                                    </div>
                                    <div class="control-group">
   ...
   <script>
     ...
     function myconfirm(){
		 ...
		 //set text
			...
			$('#confirm_contact').text(document.getElementById("contact_id").value);
			$('#confirm_brand_reminder').text(document.getElementById("brand_reminder").value);
