               ...
               <div class="span12">
                  <div class="portlet box blue" id="form_wizard_1">
                     <div class="portlet-title">
                        <div class="caption">
                           <i class="icon-reorder"></i>Profession Details Form - <span class="step-title">Step 1 of 2</span>
                        </div>
                                 ...
                                 <div class="navbar-inner">
                                    <ul class="row-fluid">
                                       <li class="span3">
                                          ...
                                          <span class="desc"><i class="icon-ok"></i> Profession Setup </span>   
                                          </a>
                                       </li>
                                       <li class="span3">
                              ...
                              <div class="tab-content">
                                 <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input id ="profession" type="text" name="profession" class="span6 m-wrap" />
