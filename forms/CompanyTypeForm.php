               ...
               <div class="span12">
                  <div class="portlet box blue" id="form_wizard_1">
                     <div class="portlet-title">
                        <div class="caption">
                           <i class="icon-reorder"></i>Company Type Details Form - <span class="step-title">Step 1 of 2</span>
                        </div>
                           ...
                           <div class="form-wizard">
                                 ...
                                 <div class="navbar-inner">
                                    <ul class="row-fluid">
                                       <li class="span3">
                                          ...
                                          <span class="desc"><i class="icon-ok"></i> Company Type Setup </span>   
                                          </a>
                                       </li>
                                       <li class="span3">
                              ...
                              <div class="tab-content">
                                 <div class="tab-pane active" id="tab1">
                                    <h3 class="block">Company Type</h3>
                                    <div class="control-group">
                                       <label class="control-label">Company Type</label>
                                       <div class="controls">
                                          <input id ="company_type" type="text" name="company_type" class="span6 m-wrap" />
                                          <span class="help-inline">Enter your Company Type</span>
                                       </div>
                                    </div>
